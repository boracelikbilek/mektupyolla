...
const letterTypes = [
  ...
  },
  {
    ...
    title: "Askere Mektup",
    description:
      "Vatanı görevini yapan sevdiklerinize moral ve destek gönderin.",
      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Her durum için özel kategoriler. Duygularınızı en doğru şekilde
            ifade edin.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {letterTypes.map((type, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-16 h-16 ${type.bgColor} rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                >
