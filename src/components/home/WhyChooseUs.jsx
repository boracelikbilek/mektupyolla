...
const features = [
  ...
  },
  {
    ...
    description:
      "Dakikalar içinde mektubunuzu hazırlayın, biz gerisini halledelim.",
    color: "text-blue-600",
    bgColor: "bg-blue-50",
  },
  {
  ...
  },
  {
    ...
    description:
      "Emojileri kullanın, renkli çıktılar alın, duygularınızı renklendirin.",
    color: "text-pink-600",
    bgColor: "bg-pink-50",
  },
  {
  ...
  },
  {
    ...
    title: "Dijital Arşiv",
    description:
      "Tüm mektuplarınızı güvenle saklayın, istediğiniz zaman erişin.",
      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Modern teknoloji ile geleneksel mektup kültürünü birleştiren
