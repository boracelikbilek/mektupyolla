...
const CreatePrisonLetterPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    customDeliveryDate: "",
    prisonName: "", // Cezaevi adı field'i eklendi
    recipient: {
      firstName: "",
      lastName: "",
      phone: "",
  ...
  return (
    <>
      <SEO
        title="Cezaevine Mektup Yaz | MektupYolla"
        description="Cezaevindeki sevdiklerine umut ve destek için mektup gönder"
        canonical="https://mektupyolla.com/cezaevi-mektup"
      />
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-6 sm:p-8">
                  ...
                  <div className="mb-6 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-xl p-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="text-sm font-bold text-orange-900 dark:text-orange-200 mb-1">
                  ...
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, prisonName: e.target.value })
                      }
                      ...
                      placeholder="Örn: Silivri Cezaevi"
                    />
                  </div>
...
export default CreatePrisonLetterPage;
