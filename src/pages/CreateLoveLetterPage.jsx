...
const CreateLoveLetterPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    envelopeText: "",
    addons: [],
    deliveryDays: 3, // Sevgiliye mektup için hızlı teslimat (3 gün)
    recipient: {
      firstName: "",
      lastName: "",
      phone: "",
  ...
  const calculateDeliveryDate = () => {
    ...
    deliveryDate.setDate(today.getDate() + formData.deliveryDays);
    return deliveryDate;
  };
  ...
  const canProceed = () => {
    switch (currentStep) {
      ...
      case 5:
        return formData.deliveryDays > 0;
      case 6:
        return (
          ...
          {currentStep === 5 && (
            <div className="animate-fadeIn">
              <div className="text-center mb-8 sm:mb-12">
                ...
                <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                  Sevgiliye mektup hızlı teslimat ile gönderilir.
                </p>
              </div>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {[3, 5, 7].map((days) => (
                      <button
                        ...
                        className={`py-6 px-4 rounded-xl font-semibold transition-all duration-300 ${
                  ...
                  <div className="mt-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 border border-blue-200 dark:border-blue-800">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="text-sm text-blue-900 dark:text-blue-200">
                        <p className="font-semibold mb-1">Teslimat Tarihi:</p>
                        <p>
                          Mektubun{" "}
                          <span className="font-bold">
                            {formData.deliveryDays} gün içinde
                          </span>{" "}
                          (
                          <span className="font-bold">
