...
const CreateMilitaryLetterPage = () => {
  const { user } = useAuth();
  ...
  return (
    <>
      <SEO
        title="Askere Mektup Yaz | MektupYolla"
        description="Askerlik yapan sevdiklerine moral ve destek için mektup gönder"
        canonical="https://mektupyolla.com/askere-mektup"
      />
...
export default CreateMilitaryLetterPage;
